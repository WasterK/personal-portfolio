...
export class PortfolioComponent {
  projects = [
    { name: 'IoT Device Management System', description: 'Client-server architecture for managing IoT devices', link: 'https://github.com/WasterK/kws-pmd-backend',tryLink: 'https://kws-pmd-web-jwt.onrender.com', show: true },
